...
Thingiview = function(containerId) {
  ...
  sceneLoop = function() {
    ...
    if (object) {
      ...
      countCallsGlobal++;
      if(mouseDown && mouseOver && countCallsGlobal%50 == 0) {
          var xzPair = [object.rotation.x, object.rotation.z];
          // alert('array x, z: ', xzPair[0], xzPair[1]);
          // $('#debugArea').append('x:'+ object.rotation.x + " z:" + object.rotation.z);
          estimate3D.append3Dclick(xzPair);
          $('#debugArea').prepend('array x, z: ', xzPair[0], xzPair[1]);
          
      }
      // if(countCallsGlobal%1000 == 0){
      //    estimate3D.append3Dclick(null);
      // }
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/estimate3D/stlScripts/thingiview.js');
};
